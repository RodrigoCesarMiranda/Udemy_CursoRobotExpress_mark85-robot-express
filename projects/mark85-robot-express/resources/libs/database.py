...
client = MongoClient('mongodb+srv://qa:xperience@cluster0.ggzqjmh.mongodb.net/?appName=Cluster0')
...
# Linhas de códigos para poder excluir o cadastro lançado no caso de teste que está alimentando o
# banco dados no mondodb.